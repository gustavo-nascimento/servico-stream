...
public class Filme{
    ...
    private ArrayList<Cliente> usuarios_que_assistiram;
    ...
    public ArrayList<Cliente> getUsuarios_que_assistiram() {
    ...
    public void setUsuarios_que_assistiram(ArrayList<Cliente> usuarios_que_assistiram) {
        this.usuarios_que_assistiram = usuarios_que_assistiram;
    }
    
    public void assistido(Cliente usuario){
